...
import styles from './BusinessImagePicker.module.css';
 ...
 */
export function BusinessImagePicker({ file, onChange, disabled = false }: Props) {
  const { t } = useTranslation();
  const { accept, limitHint } = useBusinessImageMessages();
  const inputId = useId();
      ...
      {previewUrl && (
        <div className={styles.preview}>
          <img
            ...
            src={previewUrl}
            alt={t('businessImage.previewAlt')}
          />
